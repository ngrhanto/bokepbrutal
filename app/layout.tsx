...
export const metadata: Metadata = {
    ...
    verification: {
        google: 'mT1gLBKJQNXx44o6uCm3ReWJfU2SHnVAryhdnvY2eiY',
        yandex: '37271d6b6f6c4246',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://bokepbrutal.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Bocil Ngentot Jilbab Smp Mama Viral Sma Tante Live Paksa Bokep Abg Jepang Jav Barat Korea China Terbaru`,
        "image": "https://bokepbrutal.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepbrutal.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
